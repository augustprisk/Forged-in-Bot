...
describe('doubleDownGuess (integration)', () => {
	...
	test('should add secondGuess to August\'s last guess', () => {
		makeGuess('August', 'John Doe', '5', '10', TEST_DB_PATH);
		doubleDownGuess('August', 'Jane Smith', TEST_DB_PATH);
	...
	test('should add secondGuess to Grace\'s last guess', () => {
		makeGuess('Grace', 'Alice Wonder', '3', '8', TEST_DB_PATH);
		doubleDownGuess('Grace', 'Bob Johnson', TEST_DB_PATH);
	...
	test('should not affect other properties of the guess', () => {
		makeGuess('Grace', 'Original Contestant', '7', '15', TEST_DB_PATH);
		doubleDownGuess('Grace', 'New Contestant', TEST_DB_PATH);
	...
	test('should work before result is recorded', () => {
		makeGuess('August', 'First Guess', '5', '10', TEST_DB_PATH);
		doubleDownGuess('August', 'Second Guess', TEST_DB_PATH);
	...
	test('should result in point deduction when double down guess loses', () => {
		makeGuess('August', 'First Guess', '5', '10', TEST_DB_PATH);
		writeResult('August', 'win', 'Sword', 1, TEST_DB_PATH);

		makeGuess('August', 'Second Guess', '6', '11', TEST_DB_PATH);
		doubleDownGuess('August', 'Wrong Guess', TEST_DB_PATH);
	...
	test('should overwrite existing secondGuess', () => {
		makeGuess('Grace', 'Original', '1', '1', TEST_DB_PATH);
		doubleDownGuess('Grace', 'First Double Down', TEST_DB_PATH);
		doubleDownGuess('Grace', 'Second Double Down', TEST_DB_PATH);
	...
	test('should not affect other player', () => {
		makeGuess('August', 'August Guess', '1', '1', TEST_DB_PATH);
		makeGuess('Grace', 'Grace Guess', '2', '2', TEST_DB_PATH);

		doubleDownGuess('August', 'August Double Down', TEST_DB_PATH);
	...
	test('should persist across operations', () => {
		makeGuess('August', 'First', '1', '1', TEST_DB_PATH);
		doubleDownGuess('August', 'First DD', TEST_DB_PATH);
	...
	test('should work in complete game flow', () => {
		// First round - normal win
		makeGuess('Grace', 'Round 1 Guess', '1', '1', TEST_DB_PATH);
		writeResult('Grace', 'win', 'Sword', 1, TEST_DB_PATH);

		// Second round - double down win
		makeGuess('Grace', 'Round 2 First', '2', '2', TEST_DB_PATH);
		doubleDownGuess('Grace', 'Round 2 Second', TEST_DB_PATH);
		writeResult('Grace', 'win', 'Axe', 1, TEST_DB_PATH);

		// Third round - double down loss
		makeGuess('Grace', 'Round 3 First', '3', '3', TEST_DB_PATH);
		doubleDownGuess('Grace', 'Round 3 Second', TEST_DB_PATH);
		writeResult('Grace', 'lose', 'Spear', 0, TEST_DB_PATH);
