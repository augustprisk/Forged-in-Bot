...
describe('makeGuess (integration)', () => {
	...
	test('should add a guess for August to the database', () => {
	...
	test('should add a guess for Grace to the database', () => {
	...
	test('should add multiple guesses for the same player', () => {
		makeGuess('August', 'First Contestant', '1', '1', TEST_DB_PATH);
		makeGuess('August', 'Second Contestant', '2', '2', TEST_DB_PATH);
		makeGuess('August', 'Third Contestant', '3', '3', TEST_DB_PATH);
	...
	test('should not affect other player when adding guess', () => {
		makeGuess('August', 'John Doe', '5', '10', TEST_DB_PATH);
	...
	test('should handle different season and episode formats', () => {
		makeGuess('Grace', 'Test Name', '10', '25', TEST_DB_PATH);
	...
	test('should initialize guess with null result and weapon', () => {
		makeGuess('August', 'New Person', '7', '14', TEST_DB_PATH);
